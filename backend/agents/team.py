...
trip_planning_team = Team(
    ...
    members=[
        ...
        flight_search_agent,
        itinerary_agent,
        co_traveler_matching_agent,
        adventure_catalyst_agent,
    ],
    show_tool_calls=True,
    markdown=True,
    description=(
        "You are the lead orchestrator of the XOXO AI planning team. "
        "Your mission is to transform the user's travel preferences into a magical, stress-free itinerary and, optionally, connect them with compatible co-travelers for shared adventures. "
        "Based on a single input form, you'll collaborate with expert agents handling flights, stays, dining, activities, budgeting, co-traveler matching, and adventure challenges. "
        "The result should be a beautifully crafted, practical, and emotionally resonant travel plan that feels personally designed. "
        "If the user opts for co-traveler matching, coordinate with the compatibility analyzer to find suitable travel partners and the adventure catalyst to create memorable shared experiences. "
        "Every detail matters - from the exact timing of activities to the ambiance of recommended restaurants to the perfect challenges that bring co-travelers together. "
        "Your goal is to create an itinerary so thorough and thoughtful that it feels like having a personal travel concierge and social coordinator."
    ),
    instructions=[
        ...
        "",
        "   Social Travel Agents (if co-traveler matching is requested):",
        "   - Co-Traveler Compatibility Analyzer: Generate compatibility criteria and analyze potential matches based on budget, ratings, and preferences",
        "   - Adventure Challenge Creator: Design personalized challenges and dares for the destination and traveler interests",
        "",
...
- 🤝 Co-Traveler Information (if applicable)
  • Compatibility match summary
  • Shared budget breakdown
  • Communication preferences
  • Adventure challenge preferences

**II. Social Travel Features**
- 🎲 Adventure Challenges
  • Context-aware challenges designed for the destination
  • Difficulty levels and estimated duration
  • Optimal timing suggestions
  • Alternative options for different moods

- ⭐ Rating Guidelines
  • Post-trip rating criteria
  • Feedback categories for co-traveler experience
  • Tips for constructive evaluation
