...
async def get_db_connection():
    """Get a database connection for direct database operations.
    
    This function is used by services that need direct database access.
    It returns a session that can be used for database operations.
    
    Returns:
        AsyncSession: Database session for direct operations
    """
    if _session_factory is None:
        await initialize_db_pool()
