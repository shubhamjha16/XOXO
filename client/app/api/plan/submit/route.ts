  ...
  try {
    ...
    const savedTripPlan = await prisma.tripPlan.create({
      data: {
        ...
        experienceDatesStart: tripData.experienceDates.start,
        experienceDatesEnd: tripData.experienceDates.end || null,
    ...
    const requestBody = {
      ...
      travel_plan: {
        ...
        travel_dates: {
          start: tripData.experienceDates.start,
          end: tripData.experienceDates.end || ""
        },
        date_input_type: tripData.dateInputType,
        duration: tripData.duration,
        traveling_with: tripData.experiencingWith,
        adults: tripData.adults,
        children: tripData.children,
        age_groups: tripData.ageGroups,
        budget: tripData.budget,
        budget_currency: tripData.budgetCurrency,
        travel_style: tripData.experienceStyle,
