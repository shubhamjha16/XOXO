        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <Card className="w-full max-w-md">
                <CardHeader className="text-center">
                    <CardTitle className="text-3xl font-bold">Welcome to XOXO</CardTitle>
                    <CardDescription>
                        Sign in to find your perfect experience partner
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    {error && (
                        <div className="p-3 bg-destructive/10 border border-destructive/30 rounded-lg text-destructive text-sm">
                            ...
                            {error === "AccessDenied" && "Sign in was denied. Please try again."}
                            {error === "Default" && "Something went wrong. Please try again."}
                            {!["OAuthSignin", "OAuthCallback", "AccessDenied", "Default"].includes(error) &&
