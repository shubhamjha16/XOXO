...
export default function CoExperiencerProfilePage() {
    ...
    const onSubmit = async (data: ProfileFormData) => {
        ...
        try {
            ...
            const response = await fetch("/api/coexperiencer/profile", {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                router.push("/coexperiencer/find");
            } else {
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Set your comfortable experience budget range
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <Label htmlFor="pace">Experience Pace</Label>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="experience_dates_flexible">
                                    I have flexible experience dates
                                </Label>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Write a brief bio to help potential experience companions get to know you
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Textarea
                                {...register("bio", { maxLength: 500 })}
                                placeholder="Tell us about yourself, your past experiences, and what you're looking for in an experience companion..."
                                rows={4}
                            />
